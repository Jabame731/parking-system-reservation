...
//Approve paypal payment and update reservation to paid
...
//         error: {
//           statusCode: 400,
//           errorMessage: "Reservation already paid",
//         },
//       };
//     }
...
//         error: {
//           statusCode: 400,
//           errorMessage: "PayPal capture not completed",
//         },
//       };
//     }

//     let storedPayment: PaymentResultData | null = null;

//     if (reserve.paymentResult) {
//       try {
//         storedPayment =
//           typeof reserve.paymentResult === "string"
//             ? JSON.parse(reserve.paymentResult)
//             : reserve.paymentResult;
//       } catch {
//         storedPayment = null;
//       }
//     }

//     if (storedPayment?.id && storedPayment.id !== paypalOrderId) {
//       return {
//         success: false,
//         error: {
//           statusCode: 400,
//           errorMessage: "PayPal order ID mismatch",
//         },
//       };
//     }

//     // Build payment result from capture
...
//       error: {
//         statusCode: 404,
//         errorMessage: "Reservation is already paid",
//       },
//     };
//   }
...
//     WHERE id = ?
//     `,
//     [JSON.stringify(paymentResult), true, new Date(), reservationId],
//   );
